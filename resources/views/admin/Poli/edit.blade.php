...
<body class="bg-white text-black">
    ...
    <div class="flex">
        ...
        <div class="flex-1 p-6 ml-64 mt-12">
            ...
            <form action="{{ route('admin.poli.update', $poli->id) }}" method="POST" class="bg-gray-100 p-6 rounded-lg">
                @csrf
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <textarea id="keterangan" name="keterangan" rows="3"
                        class="w-full mt-1 p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring focus:ring-blue-500">{{ $poli->keterangan }}</textarea>
                </div>
